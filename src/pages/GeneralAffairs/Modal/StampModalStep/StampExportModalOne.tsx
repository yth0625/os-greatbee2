...
const StampExportModalOne: React.FC<StampImportModalProps> = ({
  onClose,
  nextStep,
}) => {
  ...
  return (
    <Container>
      <ModalWrapper>
        ...
        <BtnWrapper>
          <button>임시 저장</button>
          <button onClick={() => nextStep(1)} >확인</button>
        </BtnWrapper>
      </ModalWrapper>
    </Container>
  );
...
export default StampExportModalOne;
