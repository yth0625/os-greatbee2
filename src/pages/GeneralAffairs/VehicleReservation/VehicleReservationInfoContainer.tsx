...
const VehicleReservationContainer: React.FC<VehicleReservationContainerProps> = ({
    ...
    useEffect(()=>{
        if (type === 'change') setHeader('업무용 차량 정보 변경');
        else if (type === 'new') setHeader('업무용 차량 신규 등록');
    },[type]);
    ...
    return (
        <Container>
            ...
            <Content>
                <ContentHeader>[차량 정보]</ContentHeader>
                <InputLayer>
                ...
                <InputLayer>
                    <InputHeader>차량번호</InputHeader>
                    <div style={{display: 'flex', width: '100%', height: '100%', gap: '13px'}}>
                        <InputForm placeholder="내용을 입력해 주세요"/>
                    </div>
                </InputLayer>   
                <InputLayer>
                    <InputHeader>연식</InputHeader>
                    <div style={{display: 'flex', width: '100%', height: '100%', gap: '13px'}}>
                        <InputForm placeholder="내용을 입력해 주세요"/>
                    </div>
                </InputLayer>   
                <InputLayer>
                    <InputHeader>등록일</InputHeader>
                    <div style={{display: 'flex', width: '100%', height: '100%', gap: '13px'}}>
                        <InputForm placeholder="내용을 입력해 주세요"/>
                    </div>
                </InputLayer>   
                <InputLayer>
                    <InputHeader>운행 거리</InputHeader>
                    <div style={{display: 'flex', width: '100%', height: '100%', gap: '13px'}}>
                        <InputForm placeholder="내용을 입력해 주세요"/>
                    </div>
                </InputLayer>   
                <InputLayer style={{gap: '30.68px'}}>
                    <InputHeader style={{width: '100px'}}>주행가능연령</InputHeader>
                    <div style={{display: 'flex', width: '100%', height: '100%', gap: '13px'}}>
                        <InputForm placeholder="내용을 입력해 주세요"/>
                    </div>
                </InputLayer>   
                <InputLayer>
                    <InputHeader>렌트사</InputHeader>
                    <div style={{display: 'flex', width: '100%', height: '100%', gap: '13px'}}>
                        <InputForm placeholder="내용을 입력해 주세요"/>
                    </div>
                </InputLayer>   
                <InputLayer>
                    <InputHeader>보험사</InputHeader>
                    <div style={{display: 'flex', width: '100%', height: '100%', gap: '13px'}}>
                        <InputForm placeholder="내용을 입력해 주세요"/>
                    </div>
                </InputLayer>  
